...
//    val xTicks: List<Pair<Nu Rect()mber, String>>,
...
//    companion object {
//
//        operator fun invoke(scope: IChartDrawScope): SinglePlot? {
...
//        }
//
//        private fun List<Pair<Number, String>>.yLabelFontSize(scope: IChartDrawScope): Float {
...
//        }
//
//        private fun List<Pair<Number, String>>.xLabelFontSize(scope: IChartDrawScope): Float {
//            if (isEmpty()) return 0f
